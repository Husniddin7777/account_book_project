...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Расход') }}</div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('outgo.store') }}">
                            ...
                            <div class="form-group">
                                ...
                                <select name="category_id"
                                        ...
                                        required>
                                    @foreach($outgo_categories as $category)
                            ...
                            <div class="form-group row">
                                <label for="sum"
                                       class="col-md-4 col-form-label text-md-right">{{ __('Сумма') }}</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="comment"
                                       class="col-md-4 col-form-label text-md-right">{{ __('Комментарий') }}</label>
                                <div class="col-md-6">
